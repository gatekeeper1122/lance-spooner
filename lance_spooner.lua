...
menyoovmain_root = menu.list(menu.my_root(), "Vehicles", {"lancespoonermenyoovehicles"}, "All vehicles in your directory!")
menyoom_root = menu.list(menu.my_root(), "Maps", {"lancespoonerallmaps"}, "All maps in your directory")
menyoomloaded_root = menu.list(menu.my_root(), "Currently loaded maps", {"lancespoonerloadedmaps"}, "Maps you have loaded")
menyoovloaded_root = menu.list(menu.my_root(), "Currently loaded vehicles", {"lancespoonerloadedvehicles"}, "Vehicles you have spawned")
